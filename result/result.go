// Package result provides helper functions for working with gust.Result types.
package result
...
func Assert[T any, U any](o gust.Result[T]) gust.Result[U] {
	...
	return gust.TryErr[U](o.UnwrapErr())
}
